...
\mysection{Exponential Extensions over Simple Algebraic Extensions}
...
can use the tools of Chapter \ref{chap:Algebraic Curves} to solve Risch equations in a simple
...
Our approach in Chapter \ref{chap:The Exponential Extension} was to identify the poles in $S$ and $T$
...
\begin{sageblock}[ex10.1]
differential_divisor_of_poles(S*x.differential())
Tdp = differential_divisor_of_poles(T*x.differential())
\end{sageblock}
...
\label{sec: The K[theta]-module I}
