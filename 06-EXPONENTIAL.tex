...
D_i = \frac{c_{i,1} - C_{i,1}'(\theta) - Q_{i,1}(\theta)}{n_i'(\theta) - k' n_i(\theta) \deg_\theta n_i(\theta)}
\end{equation}
...
$$D_{1} = \frac{c_{1,1}}{n_1'(\theta) - k' n_1(\theta) \deg_\phi n_1(\theta)} = \frac{i}{i \phi - i (\phi-1)} = 1$$
$$D_{2} = \frac{c_{2,1}}{n_2'(\theta) - k' n_2(\theta) \deg_\phi n_2(\theta)} = \frac{i}{i \phi - i (\phi+1)} = -1$$
...
$$ D_1 = \frac{c_{1,1}}{n_1(\theta)' - k' n_1(\theta) \deg_\theta n_1(\theta)} = \frac{1}{i \theta - i (\theta -i )} = -1$$
$$ D_2 = \frac{c_{2,1}}{n_2(\theta)' - k' n_2(\theta) \deg_\theta n_2(\theta)} = \frac{-1}{i \theta - i (\theta +i )} = -1$$
...
\begin{enumerate}
\item $\deg A = \deg B + 1$ and $\deg p =-\frac{{\rm lc}\,B}{{\rm lc}\,A} $
...
$$ D_1 = \frac{c_{1,1}}{n_1(\theta)' - k' n_1(\theta) \deg_\theta n_1(\theta)} = \frac{2}{(\ln 2) \Psi - \ln 2 (\Psi +1 )} = -\frac{2}{\ln 2}$$
...
$$A_0' = a_0 - D_1 k' \deg_\Psi n_1(\Psi) = -1 + \frac{2}{\ln 2} \ln 2 = 1$$
$$A_0 = x$$
