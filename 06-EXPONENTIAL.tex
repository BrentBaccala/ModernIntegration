...
$$A r' - \frac{S}{T} r = C \qquad A,B,C \in {\mathbb C}[x] \qquad r \in {\mathbb C}(x)$$

$$A T r' - S r = C T \qquad A,B,C \in {\mathbb C}[x] \qquad r \in {\mathbb C}(x)$$
...
$$A F^{a} (N' F D - m N D F' - N F D') - B N F^{b+1} D = C D^2 F^{c+m+1}$$
