...
{\small\begin{verbatim}
(%i198) ratexpand((-%i*256/963)*gcdex(expand(a-(%i/2)*diff(b,x)),b,x));

                         2
                  16 %I x     x    27 %I    48 x   13 %I   3       2
(%o198)          [-------- + --- - -----, - ---- - -----, x  + %I x  - 3 x - 2 %I]
                    107      107    107     107     107
(%i200) ratexpand((%i*256/963)*gcdex(expand(a+(%i/2)*diff(b,x)),b,x));

                           2
                    16 %I x     x    27 %I  13 %I   48 x   3       2
(%o200)          [- -------- + --- + -----, ----- - ----, x  - %I x  - 3 x + 2 %I]
                      107      107    107    107    107
\end{verbatim}}

$$\int {{x^4-3x^2+6}\over{x^6-5x^4+5x^2+4}} dx =
   {i\over2}\log(x^3+ix^2-3x-2i) - {i\over2}\log(x^3-ix^2-3x+2i)$$
...
What went wrong?  We gain a
key insight, as is so often the case, by graphing first the integrand:

\begin{center}
\includegraphics[width=0.7\textwidth]{04-RATIONALS-EXAMPLE1e.pdf}
\end{center}

And now the (indefinite) integral:

\begin{center}
\includegraphics[width=0.7\textwidth]{04-RATIONALS-EXAMPLE1f.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{04-RATIONALS-EXAMPLE1c.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{04-RATIONALS-EXAMPLE1d.pdf}
\end{center}
