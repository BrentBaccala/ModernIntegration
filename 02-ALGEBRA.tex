...
def long_division(dividend, divisor):
   ...
   while (remainder != 0) and remainder.degree() >= divisor.degree():
      ...
      sterm = expand(quo(LT(remainder.as_expr()), LT(divisor.as_expr())) * divisor.as_expr())
      sterm = Poly(sterm, divisor.gen)
...
\sympyc{long_division(x**2+2*x+1, 2*x+1)}
