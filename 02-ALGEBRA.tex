...
\begin{enumerate}[resume]
\item $21\,y^2+3\,x^2\,y+14\,x\,y-16\,y+2\,x^3-7\,x^2+22\,x-77$

\lstinline!expand((3*y+2*x-7)*(7*y+x^2+11))!

Ans: $\left(3\,y+2\,x-7\right)\,\left(7\,y+x^2+11\right)$

\item $y^4+x^2\,y^3+y^3+2\,x^2\,y-3\,y+2\,x^4-x^2-3$

\lstinline!expand((y^3+2*x^2-3)*(y+x^2+1))!
