...
First, consider all possible subsets of the variables.  Which subsets,
when set to zero, zero out the entire ideal (all we need to check are its generators)?
A largest such
...
polynomial ring over that fraction field generated by the remaining elements $C(u)[x\\u]$.
In this ring, the ideal is zero-dimensional.
