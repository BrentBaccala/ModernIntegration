...
Our solution to this problem was to regard the entire algebraic curve
...
ordinary point} of the curve, albeit one with {\it ramification}.
Otherwise, multiple cycles are required to cover all of the sheets,
and we have a {\it singular point}.  Analytically, both partial
derivatives of the curve's polynomial are zero at a singular point,
while at least one is non-zero at ordinary points.  This analysis is
facilitated by Newton polygons.
