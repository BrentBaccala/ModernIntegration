...
def puiseux_cycle(f, x0, y0, n, hne):
    ...
    ed = singular.extdevelop(hne, n-1)
    ...
    yexpansion = PSring(yexpansion).add_bigoh(n)
...
def puiseux2(origf, x0, y0, n, normalize=True, *args):
...
def puiseux(f, x0, y0, n, normalize=True, *args):
    p = puiseux2(f, x0, y0, n, normalize=normalize, *args)
    (x,y) = f.parent().gens()
    for cycle in p:
