...
construct the square root of the series expansions (as another series expansion),
reverse it (explain this step), and substitute the reversed series
to change the uniformizing variable and confirm our calculation:

\begin{sageblock}[ch7]
t = F.completion(pl, prec=4)(x-1)^(1/2)
