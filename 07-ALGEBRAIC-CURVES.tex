...
def riemannrochKash(f, ZeroIdeal, PoleIdeal):
    ...
    I = O.Ideal(*[g.subs({xx:x, yy:ybar}) for g in ZeroIdeal.gens()])
    D = I.Divisor()
    B = D.Basis()


    return B.sage({x: xx, ybar: yy})
\end{sageblock}
...
riemannrochKash(f, P1, I)
riemannrochKash(f, P1^2, I)
riemannrochKash(f, P1^3, I)
riemannrochKash(f, P1^4, I)
\end{sageblock}
...
inf = ideal(z, x);
I = ideal(R(1));
#riemannroch(f, P(1,1)*P(1,-1)*P(-1,1)*P(-1,-1)*inf^2, I)
\end{sageblock}
