...
trivial, but algorithms to do this have been known for over a hundred years.  The state
of the art today is Hess' algorithm, which was published twenty years ago and is the
subject of a book (REFERENCE).
