...
by the principle parts of the Puiseux expansions at its poles.

A {\it Mittag-Leffler problem} is the practical application of this
theorem -- given a set of principle parts, find a function that
...
The input data is a set of principle parts or, alternately, a divisor
...
Now let's construct a Maxima function to extract the principle parts
...
We now compute its principle parts matrix:
