...
\example Find the principal parts of $\frac{x}{y} dx$ on the curve
$y^2 = 1 - x^2$

Differential forms are different from functions, and have different
series expansions.  This is primarily due to the presence of the
...
1$, expressed in terms of $t$.  Now $x=\pm 1 + t^2$, so $dx=2t\,dt$

$$\frac{x}{y} dx = \pm \left[\pm 1 + t^2 \right] \left[ -\frac{\sqrt{2}}{2} it^{-1} + \cdots \right] 2t\,dt$$

$$\frac{x}{y} dx = \left[ -\sqrt{2} i + \cdots \right] \,dt$$

In short, even though both $\frac{1}{y}$ and $\frac{x}{y}$ have poles
at $x=\pm 1$, $\frac{x}{y} dx$ does not!  Its behavior at infinity
also requires analysis, since $x$ and $dx$ both have poles at
infinity, but $\frac{1}{y}$ does not.
