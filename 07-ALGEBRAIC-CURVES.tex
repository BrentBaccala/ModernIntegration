...
lower_convex_points(list) := block([result, nxt, slopes, lowest_slope],
   ...
   list: sort(list, lambda([u,v], u[1] < v[1] or u[2] < v[2])),
   ...
   result: [pop(list)],
   /* step 4 - rotate around the lower convex hull, adding points until we reach the horizontal */
...
newton_polygon(f, x, y, x0, y0, filename) := block([newton_points],
   newton_points : lower_convex_points(monomial_powers(f,x,y,x0,y0)),
   plot2d([[discrete, newton_points], 'lower_convex_hull(newton_points, l)], [l,0,3], [y,0,3],
...
newton_polygon(y^2-(x^2-1), x, y, 1, 0, "./07-GRAPH2.pdf")$
\end{maximablock}
