...
\begin{maximacode}
pf: partfrac(N/denom(integrand), t);
A[0]: x - t;
\end{maximacode}
...
ratsimp(diff(%,x)
   - subst([t=log(x+1), p=exp(x^2)],
           integrand));
/* 'integrate(subst([t=log(x+1), p=exp(x^2)], integrand),x) = %; */
/* integrate(subst([t=log(x+1), p=exp(x^2)], integrand),x); */
\end{maximacode}
...
S: ratsimp(r[1] - divide(r[1],vtick,t)[1]*vtick);
T: ratsimp(r[2] + divide(r[1],vtick,t)[1]*v);
\end{maximacode}
