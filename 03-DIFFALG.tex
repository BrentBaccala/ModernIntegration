...
let $p=\sum p_i \theta^i$ be a polynomial in $K[\theta]$.  Then:
...
transcendence of $E$ over $K$.  So $p$ most be monomial.

Conversely, assume $p$ is monomial, say $a\theta^n$.  Then $p' = (a' +
