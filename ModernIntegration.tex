...
%\newcommand{\maximaoutputstring}[1]{$$#1$$}
\newcommand{\maximaoutputstring}[1]{\maximaoutputmath{#1}}
...
\renewenvironment{maximablock}{\renewcommand{\maximaoutputmath}[1]{}\renewcommand{\maximaoutputstring}[1]{}\maximacode}{\endmaximacode
